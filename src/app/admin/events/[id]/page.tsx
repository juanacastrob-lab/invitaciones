        ...
        <div className="space-y-6">
          <section className="rounded-sm border border-stone-200 bg-white p-5">
            ...
            <EventBasicsForm eventId={id} initial={{
              ...
              rsvpDeadline: event.rsvp_deadline ? event.rsvp_deadline.slice(0, 10) : '', allowPublicRsvp: event.allow_public_rsvp, showPrivateGifts: event.show_private_gifts, checkinEnabled: event.checkin_enabled, autoReminders: event.auto_reminders, reminderDays: event.reminder_days ?? [7, 3], saveTheDateEnabled: event.save_the_date_enabled, eventReminderHours: event.event_reminder_hours ?? [],
