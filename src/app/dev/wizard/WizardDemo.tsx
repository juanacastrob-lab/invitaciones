...
export function WizardDemo({ step }: { step: 'design' | 'details' }) {
  ...
  return step === 'design' ? <DesignStep d={d} set={set} locale="es" /> : <DetailsStep d={d} set={set} draftKey="demo" eventType="boda" contact={contact} setContact={setContact} express />;
}
